...
from .tool_exceptions import CalculationError, DataQualityError, ValidationError
from .toolset_utils import load_df, save_df_to_analysis_dir
...
def SUM(
    ...
    values: list[float | int] | list[Decimal] | pl.Series | np.ndarray | str | Path,
) -> Decimal:
    """
...
def MOD(
    ctx: RunContext[FinnDeps],
    dividends: list[float | int] | list[Decimal] | pl.Series | np.ndarray | str | Path,
    *,
    divisors: list[float | int] | list[Decimal] | pl.Series | np.ndarray | str | Path,
) -> list[Decimal]:
    """
...
def WEIGHTED_AVERAGE(
    ...
    values: list[float | int] | list[Decimal] | pl.Series | np.ndarray | str | Path,
    *,
    weights: list[float | int] | list[Decimal] | pl.Series | np.ndarray | str | Path,
) -> Decimal:
    """
